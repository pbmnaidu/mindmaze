...
def run_compliance_engine():
    ...
    rules = {
        ...
        "C04": (c04, 0, "The work was completed after 15 days and on or before 1 year after sanction."),
        "C05": (c05, 35, "More than 1 year passed with no completion and no recorded progress."),
        "C06": (c06, 10, "The work has progress and is incomplete after 1 year but not more than 18 months after sanction."),
        "C07": (c07, 100, "The work has progress but is still incomplete more than 18 months after sanction."),
